...
<body>
	...
	<div align="center">
		...
		<c:if test="${usertype ne null}">
			...
			<h2><a href="#">우리마을 소식</a> <a href="#">우리섬 소식</a> <a href="#">베스트매치 소식</a> <a href="#">굿매치 소식</a></h2>
			<br>
		...
		<c:if test="${uaccount eq null}">
			<h1>Welcome ! </h1>
			<a href="/Commfy/jsp/login/login.jsp">Login</a>
		</c:if>
		...
		<div class="map">
			<div class="img" align="center">
				<img src="/Commfy/jsp/login/map.jpg" style="width:800px; height:auto;">
			</div>
		</div>
	</div>
</body>
